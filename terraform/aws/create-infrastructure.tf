...
module "aws-elb" {
  ...
  aws_avail_zones       = data.aws_availability_zones.available.names
  aws_subnet_ids_public = module.aws-vpc.aws_subnet_ids_public[0]
...
resource "aws_instance" "bastion-server" {
  ...
  subnet_id = element(module.aws-vpc.aws_subnet_ids_public[0], count.index)

  vpc_security_group_ids = module.aws-vpc.aws_security_group[0]
...
resource "aws_instance" "k8s-master" {
  ...
  # subnet_id = element(module.aws-vpc.aws_subnet_ids_private[0], count.index)
  subnet_id = element(module.aws-vpc.aws_subnet_ids_public[0], count.index)
